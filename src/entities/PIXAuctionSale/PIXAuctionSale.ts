...
export class PIXAuctionSale__landTreasuryResult {
  value0: Address;
  value1: BigInt;
  value2: BigInt;
...
export class PIXAuctionSale__pixtTreasuryResult {
  value0: Address;
  value1: BigInt;
  value2: BigInt;
...
export class PIXAuctionSale extends ethereum.SmartContract {
  ...
  landTreasury(): PIXAuctionSale__landTreasuryResult {
    ...
    return new PIXAuctionSale__landTreasuryResult(
      result[0].toAddress(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_landTreasury(): ethereum.CallResult<PIXAuctionSale__landTreasuryResult> {
    ...
    return ethereum.CallResult.fromValue(
      new PIXAuctionSale__landTreasuryResult(
        value[0].toAddress(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  pixtTreasury(): PIXAuctionSale__pixtTreasuryResult {
    let result = super.call(
      "pixtTreasury",
    ...
    return new PIXAuctionSale__pixtTreasuryResult(
      result[0].toAddress(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_pixtTreasury(): ethereum.CallResult<PIXAuctionSale__pixtTreasuryResult> {
    let result = super.tryCall(
      "pixtTreasury",
      "pixtTreasury():(address,uint256,uint256)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new PIXAuctionSale__pixtTreasuryResult(
        value[0].toAddress(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
